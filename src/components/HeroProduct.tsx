    ...
    <section className="container-main py-12 lg:py-20 anim-fade-up">
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="relative anim-fade-up lg:sticky lg:top-24">
          ...
          <div className="absolute -bottom-3 left-4 right-4 lg:left-0 lg:right-auto lg:w-1/2 flex flex-col gap-1.5 anim-slide-up anim-delay-200">
            <div className="card-felt p-2 flex items-center gap-2">
              <div className="w-5 h-5 rounded-lg bg-emerald/10 flex items-center justify-center">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-emerald" aria-hidden="true">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
              </div>
              <div>
                <p className="text-xs font-bold text-emerald-light">96.8%</p>
                <p className="text-[10px] text-fg-muted">RTP Rata-rata</p>
              </div>
            </div>
            <div className="card-velvet p-2 flex items-center gap-2">
              <div className="w-5 h-5 rounded-lg bg-crimson/10 flex items-center justify-center">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-crimson-light" aria-hidden="true">
              ...
              <div>
                <p className="text-xs font-bold text-crimson-light">&lt; 3 Menit</p>
                <p className="text-[10px] text-fg-muted">Proses Transaksi</p>
              </div>
            </div>
          </div>
        </div>
