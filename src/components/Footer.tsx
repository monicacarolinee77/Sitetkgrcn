        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Image
              ...
              height={28}
              unoptimized
              className="h-7 w-auto object-contain hover:scale-[1.02] transition-transform duration-300"
            />
            <span className="text-xs text-zinc-400">© 2026 TOKOGACOR</span>
          </div>
          <div className="flex gap-5 text-xs font-medium text-zinc-500">
            <a href="https://tokosoon.site/auth/register?ref=zrg2e2s" className="hover:text-zinc-900 hover:-translate-y-px transition-all duration-200">Link Resmi</a>
            <a href="https://tokosoon.site/auth/register?ref=zrg2e2s" className="hover:text-zinc-900 hover:-translate-y-px transition-all duration-200">Daftar</a>
